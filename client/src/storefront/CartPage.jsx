...
const FREE_SHIP_MIN  = 50;     // free shipping above $50
const SHIP_FEE       = 4.99;
...
function CartPage() {
    ...
    const shipping   = subtotal >= FREE_SHIP_MIN ? 0 : SHIP_FEE;
    ...
    const handleCheckout = async () => {
        ...
        try {
            ...
            const msg = err.details?.length ? err.details.join('\n') : err.message;
                        ...
                        <aside className="cart-summary">
                            ...
                            {shipping > 0 && (
                                <p className="shipping-note">
                                    Add ${(FREE_SHIP_MIN - subtotal).toFixed(2)} more for free shipping
                                </p>
                            )}
                            <div className="summary-row">
                                <span>Est. Tax (8%)</span>
